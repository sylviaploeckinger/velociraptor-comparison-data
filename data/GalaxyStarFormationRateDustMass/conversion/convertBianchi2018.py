...
name = "Star Formation Rate - Dust Mass data"
plot_as = "points"
redshift = 0.02
h = h_sim

x_scatter = unyt.unyt_array([SFR_err, SFR_err])
y_scatter = unyt.unyt_array([M_derr, M_derr])

# Write everything
processed = ObservationalData()
processed.associate_x(
    SFR, scatter=x_scatter, comoving=True, description="Galaxy Star Formation Rate"
)
...
processed = ObservationalData()
processed.associate_x(
    SFR, scatter=None, comoving=True, description="Galaxy Star Formation Rate"
)
processed.associate_y(
