...
smf_scatter = unyt.unyt_array([scatter_down, scatter_up], units=1 / unyt.Mpc ** 3)
...
processed.associate_y(
    smf, scatter=smf_scatter, comoving=True, description="Galaxy Stellar Mass Function"
)
