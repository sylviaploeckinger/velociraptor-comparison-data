...
Mstar = (10. ** log10_Mstar) * unyt.Solar_Mass * (h_sim / h_obs)**-2
...
processed.associate_y(Phi, scatter=unyt.unyt_array([Phi_minus, Phi_plus]), comoving=True, description="Phi (GSMF)")
