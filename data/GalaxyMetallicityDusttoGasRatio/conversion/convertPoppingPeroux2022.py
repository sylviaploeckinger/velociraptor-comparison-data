...
d2g_distant = pow(10.0, log10_d2g_distant)
d2g_local = pow(10.0, log10_d2g_local)
...
# Meta-data
comment = "Fit obtained directly from paper Table 1"
...
processed_distant.associate_y(
    d2g_distant, scatter=None, comoving=False, description="Dust-to-Gas Ratio"
)
...
processed_local.associate_y(
    d2g_local, scatter=None, comoving=False, description="Dust-to-Gas Ratio"
)
...
processed_local.associate_redshift(redshift_local, 0.0, 0.5)
