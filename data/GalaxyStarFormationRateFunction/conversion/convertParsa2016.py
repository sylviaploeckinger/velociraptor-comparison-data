...
def process_for_redshift(z, sfrf_at_z):
    ...
    citation = "Parsa et. al. (2016)"
    bibcode = "2016MNRAS.456.3194P"
    name = "SFRF from HUDF/CANDELS/GOODS-S/UltraVISTA/COSMOS"
    plot_as = "points"
    redshift = z
    h = cosmology.h
...
input_filename = "../raw/Parsa2016.txt"
delimiter = "\t"

output_filename = "Parsa2016_{}.hdf5"
output_directory = "../"
