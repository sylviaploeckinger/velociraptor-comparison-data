...
name = "galaxy-averaged H2+HI Gas Surface Density vs Star Formation Rate Surface Density"
plot_as = "line"
...
processed.associate_x(SigmaH2, scatter=None, comoving=False, description="H2+HI Surface density")
processed.associate_y(SigmaSFR, scatter=None, comoving=False, description="Star Formation Rate Surface Density")
