...
for surv in surveys:
    ...
    M_star = pow(10, raw[:, 0]) * Zsun * unyt.dimensionless
    S2L = pow(10, raw[:, 1]) * unyt.dimensionless
    ...
    name = "Gas Metallicity - Grain Size Ratio Data"
    plot_as = "points"
    redshift = 0.02
    h = h_sim
    ...
    processed.associate_x(
        M_star, scatter=None, comoving=True, description="Galaxy Gas Metallicity"
    )
