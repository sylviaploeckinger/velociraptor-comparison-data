...
binned_data = bin_data_general(np.log10(Sigma_H2), np.log10(Sigma_SFR), array_of_interest)
...
processed.associate_x(SigmaH2, scatter=SigmaH2_err, comoving=False, description="H2 Surface density")
