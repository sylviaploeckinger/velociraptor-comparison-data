...
output_filename = "Schaye2015_stars.hdf5"
output_directory = "../"
...
# Read densities
rho_Z_star = unyt.unyt_array(raw[:, 4], "Msun")
rho_Z_star /= unyt.unyt_quantity(100.0, "Mpc") ** 3
...
citation = citation = "Schaye et al. (2015) (EAGLE)"
bibcode = "2015MNRAS..446..521S"
name = "Metal mass locked in stars density obtained from the Ref EAGLE model"
redshift = np.mean(z)
plot_as = "points"
...
processed.associate_y(
    ...
    scatter=None,
    comoving=True,
    description="Metal Mass locked in stars Density",
)
...
processed.associate_redshift(0., 0., 20.)
